...
class TestGetIterationLogPath:
    def test_path_construction(self):
        ...
        result = get_iteration_log_path("/home/user/.missioncache/active/my-task", "my-task")
        assert result == Path("/home/user/.missioncache/active/my-task/my-task-iteration-log.md")
